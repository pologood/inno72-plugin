package com.framelib.dubbo.neworder.exception;
...
public class PlaceOrderException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4761788022206465268L;
	 ...
	 public PlaceOrderException() {
	     ...
	     * @since 1.7
	     */
	    protected PlaceOrderException(String message, Throwable cause,
