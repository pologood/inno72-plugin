	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (true) {
			System.out.println("http://192.168.3.48:9003/one/count?value={0}  Result:"
					+ com.inno72.plugin.http.HttpClient.get(one + MessageFormat.format(countUri, randomEven())));
			System.out.println("http://192.168.3.48:9003/two/count?value={0}  Result:"
					+ com.inno72.plugin.http.HttpClient.get(two + MessageFormat.format(countUri, randomEven())));
			System.out.println("http://192.168.3.48:9003/three/count?value={0}  Result:"
					+ com.inno72.plugin.http.HttpClient.get(three + MessageFormat.format(countUri, randomEven())));
			System.out.println("http://192.168.3.48:9003/four/odd?value={0}  Result:"
					+ com.inno72.plugin.http.HttpClient.get(four + MessageFormat.format(oddUri, randomOdd())));
			System.out.println(
					"http://192.168.3.48:9003/one/error  Result:" + com.inno72.plugin.http.HttpClient.get(error));
			Thread.sleep(1000);
		}
